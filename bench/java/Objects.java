...
class Objects {
  ...
  public static void main(final String... args) {
    ...
    // One warm-up iteration (not timed) so JIT has a chance to compile.
    ...
    // Print nanoseconds per iteration for high-precision parsing on small N.
    System.out.printf(
      "%d-th Fibonacci number is %d%nTotal is %d%nTime is %d ns%n",
      input.get(), f, total, finish / cycles
    );
  }
}
